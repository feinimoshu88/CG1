...
class TestInvest(unittest.TestCase):
    ...
    cursor = con.cursor
    cursor.execute ("SELECT id from bid_info where name='m年年7901'")
    # 提交SQL
    connection.commit ()
    t = cursor.fetchall ()
    # a=t['tel']
    ...
    def test_login(self):
        ...
        content1 = {'access_token': 'ed39725a-5f6f-4504-adb2-07f78b9adf04', 'bidId': TestInvest.a, 'investWay': '1101',
                    'money': '10000',
    ...
    def test_loginht(self):
        ...
        r1 = requests.post ('http://192.168.1.249:8484/hk-management-services/bidInfoController/auditBid',
                            data=content1,
                            cookies=c)  # 发送请求
