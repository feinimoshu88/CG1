...
class TestInvest(unittest.TestCase):
    ...
    cursor.execute ("SELECT id from bid_info where name='m年年5904'")
    # 提交SQL
    connection.commit ()
    t = cursor.fetchall ()
    # a=t['tel']
    ...
    print(id)
    def test_login(self):
        content={'login':'15510000013','passwd':'j0kOOiDj+LWhp6rCAxJP5umWe75wQjo/0lQqZnvIQRflkvsaEYOgAC7noCFUk4DIFGUZBXK/IRKZcNHYVGOoQi1loX193tGTRIBj5/L+nrwv1ua72pNx6dD2GXiCGxAKR51PZGUygEKYD+EzS+b0RcKym7EHr/VtEOktfwCX0f8='}
    ...
    # def test_invest(self):   --投标 141  170
        content1={'bidId':TestInvest.id,'money':'10000','investRedPacketId':'-999','investRaiseInterestId':'-999'}
