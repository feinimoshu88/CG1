    ...
    def test_newyyy(self):
        ...
        for d in datas:
            with self.subTest(data=d):
                ...
                # 几个月
                driver.find_element_by_name("termValue").send_keys("3")
                # 年利率
                ...
                time.sleep(1)
                # 选择借款人
                driver.find_element_by_name("login").send_keys("14510000500")
                ...
                # 正常标  爆款标 推荐标
                driver.find_element_by_xpath(".//*[@id='bidForm']/div/div/div[26]/select/option[2]").click()
