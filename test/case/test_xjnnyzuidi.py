...
class TestNewyyy(unittest.TestCase):
    excel = DATA_PATH + '/niannyingzuidi.xlsx'
    def test_newyyy(self):
        ...
        for d in datas:
            with self.subTest(data=d):
                ...
                # 选择产品  乾坤袋-年年盈
                driver.find_element_by_xpath(".//*[@id='bidForm']/div/div/div[1]/select/option[14]").click()
                ...
                # 几个月
                driver.find_element_by_name("termValue").send_keys("1")
                ...
                driver.find_element_by_name("login").send_keys("13661202883")
