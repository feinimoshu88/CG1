...
class TestNewyyy(unittest.TestCase):
    excel = DATA_PATH + '/yueyueyingdq.xlsx'
    URL=Config().get('URL')
    ...
    def test_newyyy(self):
        ...
        for d in datas:
            with self.subTest(data=d):
                ...
                # 选择产品  月月赢
                # 月月到期还本付息 ..//*[@id='bidForm']/div/div/div[1]/select/option[3]
                # driver.find_element_by_xpath(".//*[@id='bidForm']/div/div/div[1]/select/option[3]").click()
                # 季季到期还本付息 .//*[@id='bidForm']/div/div/div[1]/select/option[5]
                # driver.find_element_by_xpath (".//*[@id='bidForm']/div/div/div[1]/select/option[5]").click ()
                # 年年到期 7
