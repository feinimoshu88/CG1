...
class Email:
    ...
    def config_content(self):
        ...
        :return:
        """
        f = open(os.path.join(readConfig.proDir, 'jktestFile', 'emailStyle.txt'))
        content = f.read()
        f.close()
    ...
    def config_image(self):
        ...
        """
        # defined image path
        image1_path = os.path.join(readConfig.proDir, 'jktestFile', 'img', '1.png')
        ...
        image2_path = os.path.join(readConfig.proDir, 'jktestFile', 'img', 'logo.jpg')
    ...
    def config_file(self):
        ...
        if self.check_file():
            ...
            zippath = os.path.join(readConfig.proDir, "jkresult", "test.zip")
