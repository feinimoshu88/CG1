...
class TestPCinvest_sh_fk(unittest.TestCase):
    ...
    a = t[0]['id']
    # def test_login(self):
    #     content={'login':'15510000011','passwd':'QW8EQ4lM09bcIHZM86COM0462PoQ+1QibJUzLsD0b7JuCUdAPrqTTvGmHSHYj3/4ME6OSTIBrjdBFmtDomdy0OcURcTEljx9LetZpEHz7uHaDje9iguklu/KfguL8QZrWQ8LgIyWe2Hxr+GfNyP0mIihASYFQGGSGtKi/Drcqn4='}
