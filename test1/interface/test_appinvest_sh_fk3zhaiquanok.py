...
class TestInvest(unittest.TestCase):
    ...
    cursor = con.cursor
    cursor.execute ("SELECT id from bid_info where name='mjfcg月月到期81403'")
    # 提交SQL
    connection.commit ()
    t = cursor.fetchall ()
    # a=t['tel']
    ...
    def test_login(self):
        content = {'access_token': 'ed39725a-5f6f-4504-adb2-07f78b9adf04','login': '15510000011',
        ...
        # --投标 141  170
        content1 = {'access_token': 'ed39725a-5f6f-4504-adb2-07f78b9adf04','bidId': TestInvest.a ,'investWay': '1101', 'money': '990000',
