...
class Test_Newyyy22 (unittest.TestCase):
    ...
    headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:47.0) Gecko/20100101 Firefox/47.0',
               ...
               'Referer': 'http://192.168.1.249:8984/hk-financial-services/index.html',
               'Content-Length': '215',
    ...
    r = requests.post (jkurl+'/hk-financial-services/indexController/fasterLogin.do',data=content, headers=headers)  # 发送请求
