...
class Test_Newyyy_pchb_tz_shfk (unittest.TestCase):
    ...
    def test_Login(self):
        ...
        for d in datas:
            with self.subTest (data=d):
                ...
                cursor.execute ("SELECT id from vas_coupon_product where type='1'")  # 卡券类型产品id
                # 提交SQL
                connection.commit ()
                pid = cursor.fetchall ()
                # pro_id = pid[0]['id']
                ...
                content1 = {'bidId': a, 'money': '10000', 'investRedPacketId':hb_id, 'investRaiseInterestId':''}
